...

{
    ...
    "category": "type",
    "text": "RepetitiveTraining\n\nA structure that holds the settings for repetitive training of the emulator. On each iteration of re-training a certain number of points is sampled from the prior. Emulator prediction variance is then obtained for this sample. The point with the highest variance is added to the training set. The model is then simulated for this additional parameter, and the emulator is re-trained.\n\nFields\n\nrt_iterations: Number of times the emulator will be re-trained.\nrt_sample_size: Size of the sample that will be used to evaluate emulator variance.\n\n\n\n"
},
